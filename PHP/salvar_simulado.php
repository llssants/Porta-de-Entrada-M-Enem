...
if (isset($_FILES['imagem_enunciado']) && $_FILES['imagem_enunciado']['error'] === 0) {
    ...
    if (move_uploaded_file($_FILES['imagem_enunciado']['tmp_name'], 'uploads/' . $nome_arquivo)) {
    ...
    echo "<script>alert('Questão salva com sucesso!'); window.location.href='cadastrar_simulado.php';</script>";
