...
<header>
  <div class="brand">
    ...
    <div>
      ...
      <p class="lead">Questões de Matemática — Álgebra, Geometria, Funções e mais</p>
    </div>
  </div>
</header>

<div class="tabs" role="tablist" aria-label="Matemática">
  <button class="tab" data-disciplina="Matemática">Matemática</button>
</div>
