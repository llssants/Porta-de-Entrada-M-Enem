...
$sql = "
    ...
    WHERE d.nome IN ('História','Geografia','Filosofia','Sociologia')
...
<div class="tabs" role="tablist" aria-label="Disciplinas de Humanas">
  <button class="tab" data-disciplina="História">História</button>
  <button class="tab" data-disciplina="Geografia">Geografia</button>
  <button class="tab" data-disciplina="Filosofia">Filosofia</button>
  <button class="tab" data-disciplina="Sociologia">Sociologia</button>
</div>
